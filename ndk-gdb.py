    ...
    def __init__(self):
        ...
        start_group.add_argument(
            ...
            help="Launch application activity (defaults to main activity, "
                 "configurable with --launch_activity)")
...
def canonicalize_activity(package_name):
    def impl(activity_name):
...
def parse_manifest(args):
    ...
    activities = map(canonicalize_activity(package_name), activities)
