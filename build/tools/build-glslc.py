...
def main(args):
    ...
    obj_out = os.path.join(args.out_dir, 'glslc/obj')
    install_dir = os.path.join(args.out_dir, 'glslc/install')

    package_src = '-'.join([os.path.join(args.out_dir, 'glslc/shader-tools'),
                            host_tag])
    ...
    merge_license_files(os.path.join(package_src, 'NOTICE'), [
