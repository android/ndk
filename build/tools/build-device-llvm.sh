...
OPTION_BUILD_OUT=
register_var_option "--build-out=<path>" OPTION_BUILD_OUT "On-device toolchain will be put at <path>/prefix"
...
fix_option BUILD_OUT "$OPTION_BUILD_OUT/build" "build directory"
