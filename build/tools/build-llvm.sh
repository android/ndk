...
run cp -a $TOOLCHAIN_BUILD_PREFIX/bin/ndk-link $TOOLCHAIN_BUILD_PREFIX/bin/le32-none-ndk-link
run cp -a $TOOLCHAIN_BUILD_PREFIX/bin/ndk-link $TOOLCHAIN_BUILD_PREFIX/bin/le64-none-ndk-link
rm -f $TOOLCHAIN_BUILD_PREFIX/bin/ndk-link

run cp -a $TOOLCHAIN_BUILD_PREFIX/bin/ndk-strip $TOOLCHAIN_BUILD_PREFIX/bin/le32-none-ndk-strip
run cp -a $TOOLCHAIN_BUILD_PREFIX/bin/ndk-strip $TOOLCHAIN_BUILD_PREFIX/bin/le64-none-ndk-strip
rm -f $TOOLCHAIN_BUILD_PREFIX/bin/ndk-strip

run cp -a $TOOLCHAIN_BUILD_PREFIX/bin/ndk-translate $TOOLCHAIN_BUILD_PREFIX/bin/le32-none-ndk-translate
run cp -a $TOOLCHAIN_BUILD_PREFIX/bin/ndk-translate $TOOLCHAIN_BUILD_PREFIX/bin/le64-none-ndk-translate
rm -f $TOOLCHAIN_BUILD_PREFIX/bin/ndk-translate
