...
# we use binutils-2.19 when building gcc-4.4.3, and bonutils-2.21
# when building gcc-4.6.
#
...
#
# $1: toolchain with version numer (e.g. 'gcc-4.4.3' or 'arm-linux-androideabi-4.6')
#
get_default_binutils_version_for_gcc ()
{
    case $1 in
        arm-*-4.4.3|x86-*-4.4.3) echo "2.19";;
