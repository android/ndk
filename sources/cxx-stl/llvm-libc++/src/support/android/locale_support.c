...
// TODO(ajwong): This table doesn't support signed chars and will index out of
// bounds. The best way to fix is to patch bionic's ctype array to support 
// both signed and unsigned char.
//
// Also, there are const correctness issues here. Not sure why yet.

char const __ctype_c_mask_table[] = {
        0,
