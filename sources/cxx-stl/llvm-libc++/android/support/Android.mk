...
# Ensure 32-bit wide chars are used, even when using a dated toolchain.
android_support_cflags := -fno-short-wchar
...
android_support_sources := \
    ...
    src/musl-ctype/__ctype_b_loc.c \
    src/musl-ctype/__ctype_get_mb_cur_max.c \
    src/musl-ctype/__ctype_tolower_loc.c \
    src/musl-ctype/__ctype_toupper_loc.c \
    src/musl-ctype/isalnum.c \
    src/musl-ctype/isalpha.c \
    src/musl-ctype/isascii.c \
    src/musl-ctype/isblank.c \
    src/musl-ctype/iscntrl.c \
    src/musl-ctype/isdigit.c \
    src/musl-ctype/isgraph.c \
    src/musl-ctype/islower.c \
    src/musl-ctype/isprint.c \
    src/musl-ctype/ispunct.c \
    src/musl-ctype/isspace.c \
    src/musl-ctype/isupper.c \
    ...
    src/musl-ctype/toascii.c \
    src/musl-ctype/tolower.c \
    src/musl-ctype/toupper.c \
